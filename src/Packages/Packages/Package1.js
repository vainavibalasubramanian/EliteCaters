  ...
  return (
    <div>
      ...
      <div> {/* Total amount section */}
        ...
        <button style={{ margin: '20px 30px' , backgroundColor:'rgb(4, 59, 21)' , color:'white' , padding:'5px 10px',border:'none' , borderRadius:'5px'}}>Order</button> {/* Order button */}
      </div>
      <footer className="footer"> {/* Footer section */}
        ...
        <div className="footer-column social"> {/* Social media icons */}
          <InstagramIcon />
          <FacebookIcon />
          <TwitterIcon />
